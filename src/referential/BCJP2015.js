    ...
    class: [
      {
        type: 'beer',
        introduction: {
          title: 'Introduction to Beer Styles',
          revision: {
            number: '1',
            $t: '2015',
          },
          section: [
            ...
            {
              sectiontitle: 'Basic Categorization',
              paragraph: [
                'The most general categorization of beer styles by yeast type is a modern craft brewing phenomenon. American brewers and most other craft brewers call beers ales if they use top-fermenting (ale) yeast and lagersif they use bottom-fermenting (lager) yeast. Most categorization systems will allow for a third classification, often called spontaneously-fermented because of the method; however, wild is perhaps a more widely-used modern craft beer term for these beers fermented with bacteria or non-saccharomyces yeast. The term wild in this context does not imply spontaneous fermentation; most are directly inoculated with the desired fermentation strains.',
            ...
            {
              sectiontitle: 'Common Attributes of All Beer Styles',
              paragraph: [
            ...
            {
              sectiontitle: 'Hop Terms',
              definitionlist: {
                definitionitem: [
                  {
                    definitionterm: 'American hops',
                    definition:
                      'modern American brewing hops from the craft beer era, typically having citrusy, resiny, evergreen, or similar characteristics. More modern hops can add even more unusual and experimental characteristics, such as stone fruit, berry, and melon.',
                  },
                  {
                    definitionterm: 'Old World hops',
                    definition:
                      'traditional European brewing hops, including Saazer-type hops, British brewing hops, and those other varieties from continental Europe. Typically described as floral, spicy, herbal, or earthy. Generally less intense than many New World hops.',
                  },
                  {
                    definitionterm: 'New World hops',
                    definition:
                  ...
                  {
                    definitionterm: 'Saazer-type hops',
                    definition:
                      'often called noble hops, traditionally among the finest continental European brewing hops. Often having a lightly floral, spicy, or herbal character; rarely brash and aggressive, typically more subtle and elegant in nature.',
                  },
                ],
              },
            },
            {
              sectiontitle: 'Malt or Mashing Terms',
              definitionlist: {
                definitionitem: [
                  {
                    definitionterm: 'Munich malt',
                    definition:
                  ...
                  {
                    definitionterm: 'Vienna malt',
                    definition:
                      'can provide a bready-toasty malt presence, but don’t expect the toasted notes to be extreme – they’re more like untoasted bread crusts than toasted bread.',
                  },
                  {
                    definitionterm: 'Pilsner or Pils malt',
                    definition:
                  ...
                  {
                    definitionterm: 'Maillard products',
                    definition:
            ...
            {
              sectiontitle: 'Yeast or Fermentation Terms',
              definitionlist: {
                definitionitem: [
                  {
                    definitionterm: 'Clean fermentation profile',
                    definition:
            ...
            {
              sectiontitle: 'Appearance Terms',
              definitionlist: {
                definitionitem: [
                  {
                    definitionterm: 'Belgian Lace (Lacing)',
                    definition:
                      'a characteristic and persistent latticework pattern of foam left on the inside of the glass as a beer is consumed. The look is reminiscent of fine lacework from Brussels or Belgium, and is a desirable indicator of beer quality in Belgium.',
                  },
                  {
                    definitionterm: 'Legs',
                    definition:
                ...
                'Note that SRM is a measure of beer color density more than hue/tint. Keep this in mind when attempting to use only SRM numbers when describing beers. Within these Guidelines, beer color descriptors generally follow this mapping to SRM values:',
                {
                  table: {
                    tr: [
                      ...
                      {
                        td: ['Deep amber/light copper', '10-14'],
                      },
                      {
                        td: ['Copper', '14-17'],
                      },
                      {
                        td: ['Deep copper/light brown', '17-18'],
                      },
                      {
                        td: ['Brown', '19-22'],
                      },
            ...
            {
              sectiontitle: 'Style Organization',
              paragraph: [
            ...
            {
              sectiontitle: 'Style Tag Reference',
              paragraph: [
                'To assist with regrouping styles for other purposes, we have added informational tags to each style. These tags indicate certain attributes of the beer that may be used for grouping purposes. The ‘meaning’ column explains the general intent of the tag, but is not meant to be rigorous, formal definition. In no way do the tags supersede the actual descriptions of the style.',
                {
                  table: {
                    ...
                    tr: [
                      ...
                      {
                        td: [{}, 'session-strength', '<4% ABV'],
                      },
                      {
                        td: [{}, 'standard-strength', '4-6% ABV'],
                      },
                      {
                        td: [{}, 'high-strength', '6-9% ABV'],
                      },
                      {
                        td: [{}, 'very-high-strength', '>9% ABV'],
                      },
                      {
                        th: {
                          colspan: '3',
                      ...
                      {
                        td: [{}, 'pale-color', 'straw to gold'],
                      },
                      {
                        td: [{}, 'amber-color', 'amber to copper-brown'],
                      },
                      {
                        td: [{}, 'dark-color', 'dark brown to black'],
                      },
                      {
                        th: {
                          colspan: '3',
                          $t: 'Fermentation/Conditioning',
                        },
                      },
                      {
                        td: [{}, 'top-fermented', 'ale yeast'],
                      },
                      {
                        td: [{}, 'bottom-fermented', 'lager yeast'],
                      },
                      {
                        td: [
                          {},
                      ...
                      {
                        td: [{}, 'lagered', 'cold conditioned'],
                      },
                      {
                        td: [{}, 'aged', 'long conditioning before release'],
                      },
                      {
                        th: {
                          colspan: '3',
                      ...
                      {
                        td: [{}, 'pacific', 'Australia, New Zealand'],
                      },
                      {
                        th: {
                          colspan: '3',
                      ...
                      {
                        td: [{}, 'amber-lager-family', {}],
                      },
                      {
                        td: [{}, 'dark-lager-family', {}],
                      },
                      {
                        td: [{}, 'porter-family', {}],
                      },
                      ...
                      {
                        td: [{}, 'strong-ale-family', {}],
                      },
                      {
                        td: [{}, 'wheat-beer-family', {}],
                      },
                      {
                        td: [{}, 'specialty-beer', {}],
                      },
                      ...
                      {
                        td: [{}, 'malty', 'malt-forward flavor'],
                      },
                      {
                        td: [{}, 'bitter', 'bitter-forward flavor'],
                      },
                      {
                        td: [
                          {},
                      ...
                      {
                        td: [{}, 'smoke', 'flavor of smoked malt or grain'],
                      },
                      {
                        td: [
                          {},
                      ...
                      {
                        td: [{}, 'wood', 'wood or barrel age character'],
                      },
                      {
                        td: [
                          {},
            ...
            subcategory: [
              {
                ...
                stats: {
                  exceptions: 'Variable by base style.',
                },
                examples: [
            ...
            subcategory: [
              {
                ...
                stats: {
                  exceptions: 'Varies with the base beer style.',
                },
                examples: [
            ...
            subcategory: [
              {
                ...
                stats: {
                  exceptions:
                    'OG: varies with base style, typically above-average FG: varies with base style ABV: varies with base style, typically above-average IBUs: varies with base style SRM: varies with base style, often darker than the unadulterated base style.',
                },
              },
              {
                id: '33B',
      ...
      },
      {
        type: 'mead',
        introduction: {
          title: 'Introduction to Mead Guidelines (Categories M1-M4)',
          revision: {
            number: '1',
            $t: '2015',
          },
          section: [
            ...
            {
              sectiontitle: '1. Important Attributes',
              definitionlist: {
                definitionitem: [
                  {
                  ...
                  },
                  {
                    ...
                    definition:
                      'A mead may be categorized as hydromel, standard, or sack strength. Strength refers to the alcohol content of the mead (and also, therefore, the amount of honey and fermentables used to make the mead). Stronger meads can have a greater honey character and body (as well as alcohol) than weaker meads, although this is not a strict rule. Well-made stronger examples may have difficult-to-detect strength. Minor differences from stated strength level should not be heavily-penalized or considered a disqualifying fault.',
                  },
                  {
            ...
            {
              sectiontitle: '2. Standard Description for Mead',
              paragraph:
                        ...
                        definitionitem: [
                          ...
                          },
                          {
                            ...
                            definition: {
                              ...
                              paragraph:
                                'Note that the perception ofsweetness is a function of the percentage of residual sugar, so don’t rely only on FG to determine sweetness. Consider the OG, strength, tannin levels, and to a lesser extent, acidity, in assessing sweetness.',
                            },
                          },
                          {
                            definitionterm: 'IBUs:',
            ...
            {
              sectiontitle: '3. Competition Entry Instructions',
              definitionlist: {
                definitionitem: [
                  {
            ...
            subcategory: [
              ...
              },
              {
                ...
                examples: [
                  ...
                  'Caress',
                  'and Mischief',
                  'White Winter Blueberry',
                  'Raspberry and Strawberry Melomels',
                  'Celestial Meads Miel Noir',
                  'Redstone Black Raspberry Nectar',
                  'Bees Brothers Raspberry Mead',
                  'Intermiel Honey Wine and Raspberries',
                  'Honey Wine and Blueberries',
                  'and Honey Wine and Blackcurrants',
            ...
            subcategory: [
              ...
              },
              {
                ...
                examples: [
                  ...
                  'iQhilika Africa Birds Eye Chili Mead',
            ...
            subcategory: [
              {
                id: 'M4A',
                name: 'Braggot',
                notes: 'A Braggot is a mead made with malt.',
                impression:
      ...
      },
      {
        type: 'cider',
        introduction: {
          title: 'Introduction to Cider Guidelines (Categories C1-C2)',
          revision: {
            number: '1',
            $t: '2015',
          },
        ...
        category: [
          {
            ...
            subcategory: [
              ...
              },
              {
                ...
                examples: [
                  '[US] Westcott Bay Traditional Very Dry',
                  'Dry and Medium Sweet (WA)',
                  'Farnum Hill Extra-Dry',
                  'Dry',
                  'and Farmhouse (NH)',
                  'Wandering Aengus Oaked Dry (OR)',
                  'Montana CiderWorks North Fork (MT)',
                  "Bellwether Heritage (NY). [UK] Oliver's Traditional Dry",
                  "Hogan's Dry and Medium Dry",
              ...
              },
              {
                ...
                notes: 'New World Perry is made from culinary/table pears.',
                impression:
          ...
          },
          {
            ...
            subcategory: [
              ...
              },
              {
                ...
                entryinstructions:
                  'EntrantsMUSTspecify carbonation level (3 levels). EntrantsMUSTspecify sweetness (5 categories). EntrantsMUSTspecify all fruit(s) and/or fruit juice(s) added.',
                examples: [
                  '[US] West County Blueberry-Apple Wine (MA)',
                  'Bellwether Cherry Street (NY)',
                  "Uncle John's Fruit Farm Winery Apple Cherry",
                  'Apple Blueberry',
                  'and Apricot Apple Hard Cider (MI)',
                ],
                stats: {
                  og: {
                    flexible: 'false',
              ...
              },
              {
                ...
                entryinstructions:
                  'EntrantsMUSTspecify carbonation level (3 levels). EntrantsMUSTspecify sweetness (5 levels).',
                examples: [
              ...
              },
              {
                ...
                entryinstructions:
                  'EntrantsMUSTspecify starting gravity, final gravity or residual sugar, and alcohol level. Entrants MUST specify carbonation level (3 levels).',
                varieties:
                  'Usually North American classic table fruit such as McIntosh or Cortland.',
                examples: [
                  '[US] various from Eden Ice Cider Company and Champlain Orchards. [Canada] Domaine Pinnacle',
                  'Les Vergers de la Colline',
                  'and Cidrerie St-Nicolas (Quebec).',
                ],
                stats: {
                  og: {
                    flexible: 'false',
              ...
              },
              {
                ...
                entryinstructions:
                  'EntrantsMUST specify carbonation level (3 levels). EntrantsMUST specify sweetness (5 categories). EntrantsMUST specify all botanicals added. If hops are used, entrant must specify variety/varieties used.',
                examples: [
              ...
              },
              {
                ...
                entryinstructions:
                  'EntrantsMUST specify all ingredients. EntrantsMUST specify carbonation level (3 levels). EntrantsMUST specify sweetness (5 categories).',
